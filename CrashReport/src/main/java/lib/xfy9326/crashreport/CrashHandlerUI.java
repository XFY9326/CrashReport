...
public class CrashHandlerUI extends Activity
{
    ...
    private void buttonset()
    {
        ...
        reason = (EditText) findViewById(R.id.edittext_crashcommit);
    }

    private void sendmail()
    {
        String MailSend = AppName + getString(R.string.crashreport_mail_main) + "\n\n" + getString(R.string.crashreport_mail_reason) + ":" + reason.getText().toString() + "\n\n" + getString(R.string.crashreport_mail_report) + ":\n" + Log;
    ...
    private void exit()
    {
        ...
        main.setClassName(this, clsname);
